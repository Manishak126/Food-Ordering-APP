        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>save up to 20%</h2>
              <p>
              Take your dining experience to the next level by downloading our mobile app today. Enjoy seamless browsing of our extensive menu, exclusive app-only deals, and lightning-fast delivery options right at your fingertips. 
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
